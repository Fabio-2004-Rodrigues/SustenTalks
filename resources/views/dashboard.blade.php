            ...
            <div class="row h-100 d-flex flex-col align-content-center my-4">
                <div class="col-lg-7 col-md-8 col-sm-10 col-12">
                    ...
                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="comentarios-tab" data-bs-toggle="tab" href="#comentarios"
                                role="tab" aria-controls="comentarios" aria-selected="false">Comentários</a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="seguidores-tab" data-bs-toggle="tab" href="#seguidores"
                                role="tab" aria-controls="seguidores" aria-selected="false">Seguidores</a>
                        </li>
                        <li class="nav-item" role="presentation">
